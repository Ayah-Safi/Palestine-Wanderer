...
<body>
    ...
    <main>
        ...
        <div class="right-side">
            <h1><i class="fas fa-globe"></i>Add Village</h1>
            <form action="">
                <label for="email"><i class="fas fa-envelope"></i> Village-Name:</label><br>
                <input type="email" id="email" name="email"><br>
                <label for="password"><i class="fas fa-key"></i>Village-Description:</label><br>
